...
function FeedbackListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('feedback', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/feedbacks/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('feedback', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            ...
            <NextLink href={`/feedbacks/create`} passHref legacyBehavior>
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('test_case', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>test_case</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('test_case', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/test-cases/view/${record.test_case?.id}`}>
